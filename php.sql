GRANT ALL PRIVILEGES ON MedokaDB.* TO 'mysqladmin'@'%';
FLUSH PRIVILEGES;

CREATE DATABASE MedokaDB;
USE MedokaDB;
...
CREATE TABLE games (
    game_id INT(8) PRIMARY KEY AUTO_INCREMENT,
...
ALTER TABLE games AUTO_INCREMENT = 10000000;
